		...
		<html lang="en" data-theme="light">
			...
			<div className="min-h-screen flex flex-col bg-base-100">
				...
				<footer className="footer footer-center p-4 bg-base-200 text-base-content">
					<aside>
						<p>Copyright © 2025 - All rights reserved by kacperadamczyk.pl</p>
					</aside>
				</footer>
			</div>
		</html>
				...
				<div className="hero-content text-center">
					<div className="max-w-md">
						<h1 className="text-5xl font-bold">
							Welcome to link.kacperadamczyk
						</h1>
						<p className="py-6">
							link.kacperadamczyk is a Deno-powered URL shortening service.
							...
							>
								<div className="card-body">
									...
									<div className="flex gap-4 text-sm text-base-content/60">
										<span>
											Created:{" "}
											{new Date(link?.createdAt as number).toLocaleDateString()}
										</span>
